...
public class WildGuideStepTwoFragment extends Fragment {

    public static WildGuideStepTwoFragment newInstance() {

        return new WildGuideStepTwoFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_wild_guide_step_two, container, false);
    }
