...
public class WildGuideStepFiveFragment extends Fragment {

    public static WildGuideStepFiveFragment newInstance() {

        return new WildGuideStepFiveFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_wild_guide_step_five, container, false);
    }
