...
public class GroupChatRedbagActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_groupchat_redbag);
//        v_send_redbag.post(() -> v_send_redbag.setEnabled(false));
    ...
    private void init() {
        ...
        redbag_type = data.getIntExtra(GroupChatRedbagActivity.K_REDBAG_TYPE, GroupChatRedbagActivity.REDBAG_TYPE_PERSONAL);
    ...
    private void getRedbagsIcons() {
        ...
        ApiRequestWrapper.openAPIGET(this, params, AsynHttpClient.API_GROUPCHAT_PACKET_ICONS, new MsgStructure() {
            ...
            public boolean onInterceptRawData(String rawStr) {
                Observable.just(rawStr).observeOn(AndroidSchedulers.mainThread()).subscribe(GroupChatRedbagActivity.this::fetchPackIcons);
                return true;
            }
    ...
    private void sendRedBag() {
        ...
        if (redbag_type == GroupChatRedbagActivity.REDBAG_TYPE_GROUP) {
        ...
        ApiRequestWrapper.openAPIPOST(this, params, api, new MsgStructure() {
            ...
            public void onReceive(JSONObject data) {
                Observable.just(data).observeOn(AndroidSchedulers.mainThread()).subscribe(object -> {
                    dismissAnimLoading();
                    if (redbag_type == GroupChatRedbagActivity.REDBAG_TYPE_PERSONAL) {
                        UserManager.updateMoney(GroupChatRedbagActivity.this, object.optString("balance"));
                    }
